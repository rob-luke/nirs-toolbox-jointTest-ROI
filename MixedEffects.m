    ...
    methods
        ...
        function G = runThis( obj, S )
            ...
            if(~ismember('source',vars.Properties.VariableNames) & ...
                ...
                if ismember('ROI',vars.Properties.VariableNames)

                    [sd, ~,lst] = nirs.util.uniquerows(table(vars.source, vars.detector, vars.ROI, vars.type));

                    sd.Properties.VariableNames = {'source', 'detector', 'ROI', 'type'};
